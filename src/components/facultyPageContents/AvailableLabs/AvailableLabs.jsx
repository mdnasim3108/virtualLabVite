...
const AvailableLabs = () => {
  const { students, labs: labData, experiments } = useContext(userContext);
  ...
  return (
    <div className="h-[70%] pt-5 w-full flex justify-evenly ">
      ...
      <div className="w-full flex overflow-hidden ">
        {labs.map((lab) => (
          <Lab {...lab} labIndex={labIndex} open={(type,message,description)=>openNotificationWithIcon(type,message,description)} />
        ))}
      </div>
