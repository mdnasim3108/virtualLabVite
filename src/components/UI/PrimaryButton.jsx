...
const PrimaryButton=(props)=>{
    return <button onClick={props.onClick} type="button" class="text-white bg-blue-700 hover:bg-blue-800  font-medium rounded text-sm px-5 py-2.5 me-2 mb-2  focus:outline-none">
        {props.children}
        </button>
}
